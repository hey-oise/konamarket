...
export default function Product({name = "", price ="", imageLink = ""}) {
  return (
    <Link target="_blank" href={`https://wa.me/2349077453404?text=hi, i need one ${name + " " + price}`} className="flex flex-row gap-5 m-auto hover:scjale-101 transition-all duration-500">
